...
const ALLOWED_ROLES = ['editor', 'creative_director', 'qa'] as const
...
export async function POST(request: Request) {
  ...
  if (!ALLOWED_ROLES.includes(role)) {
    return NextResponse.json({ error: 'Invalid role. Must be one of: editor, creative_director, qa' }, { status: 400 })
  }
