...
import {
  LayoutDashboard, Users, LogOut, User, ChevronRight, Settings
} from 'lucide-react'

interface HomeSidebarProps { profile: Profile }
...
export default function HomeSidebar({ profile }: HomeSidebarProps) {
  ...
  const links = profile.role === 'admin'
    ? [
        { href: '/dashboard/admin-home',         icon: LayoutDashboard, label: 'Command Center' },
        { href: '/dashboard/admin/employees',     icon: Users,           label: 'Manage Employees' },
      ]
    : [
        { href: '/dashboard/employee-home',  icon: LayoutDashboard, label: 'My Portals' },
      ]
